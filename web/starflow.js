(function () {
  ...
  const I18N = {
    ru: {
      ...
      'hero.title': 'Партнёрская программа: выплаты $20-40 за подтверждённые интервью каждое воскресенье в USDT.',
    ...
    en: {
      ...
      'hero.title': 'Partner program: $20-40 payouts for approved interviews every Sunday in USDT.',
    ...
    pt: {
      ...
      'hero.title': 'Programa de parceria: pagamentos de $20-40 por entrevistas aprovadas todo domingo em USDT.',
    ...
    es: {
      ...
      'hero.title': 'Programa de partners: pagos de $20-40 por entrevistas aprobadas cada domingo en USDT.',
  ...
  const EXTRA_I18N = {
    ru: {
      ...
      'footer.link.geos': 'GEO',
      'footer.link.readiness': 'Готовность',
      'footer.link.faq': 'FAQ',
    ...
    en: {
      ...
      'footer.link.geos': 'Priority GEOs',
      'footer.link.readiness': 'Readiness',
      'footer.link.faq': 'FAQ',
    ...
    pt: {
      ...
      'footer.link.geos': 'GEOs',
      'footer.link.readiness': 'Prontidão',
      'footer.link.faq': 'FAQ',
    ...
    es: {
      ...
      'footer.link.geos': 'GEOs',
      'footer.link.readiness': 'Preparación',
      'footer.link.faq': 'FAQ',
